...
import com.example.personal_finance_tracker.viewmodel.AddTransactionViewModel
...
fun AddTransactionScreen(
    ...
    val vm: AddTransactionViewModel = viewModel(
        factory = AddTransactionViewModel.Factory(txRepo, categoryRepo, uid)
    )
    ...
    Scaffold(
        ...
        Column(
            ...
            OutlinedButton(onClick = { showDatePicker = true }) {
                Text(state.date.toString()) // yyyy-mm-dd
            }
